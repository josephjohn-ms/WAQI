...
async function checkForecast(city){
    ...
    console.log(data);
    //get the day 1 and day 2 forecast
    let day1 = data.daily[0];
    let day2 = data.daily[1];

    //find the corresponding image for the forecast
    let day1Icon = "";
    ...
    document.querySelector(".forecast1").innerHTML = `Day 1: ${day1.temp.day}°C ${day1Icon}`;
    document.querySelector(".forecast2").innerHTML = `Day 2: ${day2.temp.day}°C ${day2Icon}`;
